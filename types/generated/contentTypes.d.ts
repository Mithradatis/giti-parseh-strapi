...
export interface ApiExploreDesignExploreDesign extends Schema.CollectionType {
  collectionName: 'explore_designs';
  info: {
    singularName: 'explore-design';
    pluralName: 'explore-designs';
    displayName: 'Explore Designs';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    products: Attribute.Relation<
      'api::explore-design.explore-design',
      'oneToMany',
      'api::product.product'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiGlobalTradeGlobalTrade extends Schema.SingleType {
  collectionName: 'global_trades';
  info: {
    singularName: 'global-trade';
    pluralName: 'global-trades';
    displayName: 'Global Trade';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiHeroContentHeroContent extends Schema.SingleType {
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['tile', 'interior design']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Attribute.DefaultTo<'tile'>;
    material: Attribute.Enumeration<['Marble', 'Cement', 'Ceramic']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    color: Attribute.Enumeration<
      ['white', 'black', 'gray', 'red', 'green', 'yellow', 'brown']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiProductsGridProductsGrid extends Schema.CollectionType {
  collectionName: 'products_grids';
  info: {
    singularName: 'products-grid';
    pluralName: 'products-grids';
  ...
  attributes: {
    products: Attribute.Relation<
      'api::products-grid.products-grid',
      'oneToMany',
      'api::product.product'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiQuickAccessQuickAccess extends Schema.CollectionType {
  collectionName: 'quick_accesses';
  info: {
    singularName: 'quick-access';
    pluralName: 'quick-accesses';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::explore-design.explore-design': ApiExploreDesignExploreDesign;
      'api::footer-navigation.footer-navigation': ApiFooterNavigationFooterNavigation;
      'api::global-trade.global-trade': ApiGlobalTradeGlobalTrade;
      ...
      'api::products-grid.products-grid': ApiProductsGridProductsGrid;
      'api::quick-access.quick-access': ApiQuickAccessQuickAccess;
    }
  }
}
